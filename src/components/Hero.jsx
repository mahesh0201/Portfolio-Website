  ...
  return (
    <Box
      ...
      sx={{
        ...
        alignItems: 'center',
        position: 'relative',
        background: 'radial-gradient(ellipse at 50% 0%, rgba(0,240,255,0.07) 0%, transparent 60%), #0a0a0f',
        overflow: 'hidden',
        pt: 8,
      }}
    >
      ...
      {hexagons.map((hex) => (
        <motion.div
          ...
          style={{
            ...
            width: hex.size,
            height: hex.size,
            x: mousePos.x * (hex.id % 3 === 0 ? 0.8 : hex.id % 3 === 1 ? 0.4 : 1.2),
            y: mousePos.y * (hex.id % 3 === 0 ? 0.5 : hex.id % 3 === 1 ? 1.0 : 0.3),
            pointerEvents: 'none',
          }}
          animate={{
            y: [0, -30, 0],
        ...
        <motion.div style={{ opacity }}>
          ...
          >
            ...
            <Box sx={{ flex: 1, textAlign: { xs: 'center', md: 'left' } }}>
              ...
              >
                <Box sx={{ height: 60, display: 'flex', alignItems: 'center', justifyContent: { xs: 'center', md: 'flex-start' }, mb: 2 }}>
                  <Typography
                    variant="h4"
                    sx={{
                      fontFamily: '"Share Tech Mono", monospace',
              ...
              >
                ...
                >
                  {/* REPLACE */}
                  Building secure, scalable systems at the intersection of cybersecurity
                  and modern web development. Passionate about threat prevention and
                  elegant code.
                </Typography>
              </motion.div>
              ...
              >
                <Stack direction="row" gap={2} justifyContent={{ xs: 'center', md: 'flex-start' }}>
                  <Button
                    variant="contained"
                    size="large"
            ...
            >
              ...
              >
                ...
                />
                <Avatar
                  src="/assets/images/profile-placeholder.svg" // {/* REPLACE */}
                  alt="John Doe" // {/* REPLACE */}
                  sx={{
                    width: '100%',
                    height: '100%',
      ...
      >
        ...
        >
          <Typography sx={{ fontFamily: '"Share Tech Mono"', fontSize: '0.7rem', letterSpacing: 2, mb: 0.5 }}>
            SCROLL
          </Typography>
